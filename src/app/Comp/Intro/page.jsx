...
const Page = () => {
  ...
  <div className="flex flex-col sm:flex-row items-center justify-center px-5 gap-14 relative ">
    <div className="text-center md:text-left space-y-5">
      ...
      <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-5 mt-4">
        <a href="/HammadHussainnCV.pdf" download>
          <button onClick={handleDownload} className="transition-all text-xl md:text-2xl duration-150 flex items-center ease-out rounded-full hover:text-white border-2 py-3 md:py-4 px-6 md:px-8 border-purple-500 hover:bg-purple-800 text-purple-500">
            Download CV <MdFileDownload className="text-xl md:text-2xl ml-2" />
          </button>
        </a>
        <div className="flex space-x-5 mt-4 md:mt-0">
          <a href="https://www.facebook.com/share/RaSTBRZv9xUsjJCe/?mibextid=qi2Omg" target="_blank" rel="noopener noreferrer" className="hover:scale-150 border border-purple-500 transition-all hover:bg-purple-800 hover:text-white rounded-full p-2 md:p-1 text-purple-500">
            <FaFacebookF className="text-lg md:text-xl" />
          </a>
          <a href="https://www.linkedin.com/in/hammadhussaindeveloper/" target="_blank" rel="noopener noreferrer" className="hover:scale-150 border border-purple-500 transition-all hover:bg-purple-800 hover:text-white rounded-full p-2 md:p-1 text-purple-500">
            <FaLinkedinIn className="text-lg md:text-xl" />
          </a>
          <a href="https://github.com/hamadhussain" target="_blank" rel="noopener noreferrer" className="hover:scale-150 border border-purple-500 transition-all hover:bg-purple-800 hover:text-white rounded-full p-2 md:p-1 text-purple-500">
