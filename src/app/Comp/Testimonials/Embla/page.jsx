...
// const EmblaCarousel = (props) => {
//   const { slides = [], options } = props; // Default to an empty array if slides is undefined
//   const [emblaRef, emblaApi] = useEmblaCarousel(options, [Autoplay()]);
...
//         <div className="embla__container">
//           {slides.map((slide, index) => (
//             <div className="embla__slide cursor-pointer border-2 rounded-lg p-24 text-center w-full mx-5" id={slide.id} key={index}>
//               {/* <Image src={slide.image} alt={`${slide.name}'s picture`} width={300} height={200} /> */}
//               <h3 className="text-5xl">{slide.name}</h3><br />
//               <p>{slide.position}</p>
//               <blockquote className="italic">'{slide.quote}'</blockquote>
